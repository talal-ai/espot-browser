  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-1">Panel Management</h1>
          <p className="text-sm text-gray-600 dark:text-gray-400">Manage and assign panels to users</p>
        </div>
